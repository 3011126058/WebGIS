...
//aboutMe btn Put active class for the aboutMe li and the aboutMesection
...
aboutMe.addEventListener('click', () => {
    ...
    btns.forEach((btn) => {
        btn.classList.remove('active');
        document.querySelector('[data-menu~="about"]').classList.add('active');
    });
